...
export default function privacyPolicy(){
  return (
    <>
        ...
        <title>Legal - Bula Privacy Policy - Bula</title>
        ...
        <div className="relative flex items-center justify-center w-full pt-[104px] h-full max-w-2xl mx-auto lg:max-w-7xl lg:px-8">
            ...
            <div className = "h-[30vh] text-white text-5xl py-24 font-bold">Privacy Policy</div>
            <div>
                    <p>This Privacy Policy describes how bulamics.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
                    <h1 className = "mt-10 text-xl font-bold">Contact</h1>
                    <p>After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at help@bula.com.</p>
                    <h1 className = "mt-10 text-xl font-bold">Collecting Personal Information</h1>
                    ...
                    <ul className=  "list-disc list-inside">
                        <li className = "mt-10"><u>Device information</u></li>
                        ...
                        <li className = "mt-10"><u>Order information</u></li>
                        <ul className=  "pl-6 list-disc list-inside">
                    ...
                    <h1 className = "mt-10 text-xl font-bold">Sharing Personal Information</h1>
                    ...
                    <h1 className = "mt-10 text-xl font-bold">Behavioural Advertising</h1>
                    ...
                    <h1 className = "mt-10 text-xl font-bold">Using Personal Information</h1>
                    <p>We use your personal Information to provide our services to you, which includes: offering products for sale, processing payments, shipping and fulfillment of your order, and keeping you up to date on new products, services, and offers.</p>

                    <h1 className = "mt-10 text-xl font-bold">Lawful basis</h1>
                    ...
                    <h1 className = "mt-10 text-xl font-bold">Retention</h1>
                    <p>When you place an order through the Site, we will retain your Personal Information for our records unless and until you ask us to erase this information. For more information on your right of erasure, please see the ‘Your rights’ section below.</p>

                    <h1 className = "mt-10 text-xl font-bold">Automatic decision-making</h1>
                    ...
                    <h1 className = "mt-10 text-2xl font-bold">Your rights</h1>
                    <h2 className = "mt-2 text-xl font-bold">GDPR</h2>
